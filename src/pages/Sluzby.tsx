...
const SERVICES: ServiceDetail[] = [
  ...
  },
  {
    ...
    desc: "Odborné články, newslettery, texty na web, profesní medailonky a doprovodné materiály. Cílem je text, který reprezentuje — přesný, kultivovaný a přirozený.",
    bullets: [
  ...
  },
  {
    ...
    desc: "AI umí připravit základ. Neumí ale ručit za přesnost, jednotnou terminologii ani za to, jak text působí na odborného čtenáře. Draft zpřesním, sjednotím a dotáhnu do podoby, za kterou se podepíšete.",
    bullets: [
  ...
  },
  {
    ...
    desc: "Posouzení rukopisu nebo textu: silná a slabá místa, nejasnosti, strukturální problémy — a doporučení, co upravit jako první a co už řešit nemusíte.",
    bullets: [
  ...
  return (
    <main className="page">
      <section className="section-sm container" style={{ paddingTop: "clamp(56px,7vw,96px)" }}>
        <Tag>— Moje služby</Tag>
        <h1 className="h1">Od rukopisu k vydané knize. A ke všemu mezi tím.</h1>
        ...
        {SERVICES.map((s, idx) => (
          <div
            ...
            style={{
              ...
              borderBottom: idx < SERVICES.length - 1 ? "1px solid rgba(26,23,20,0.08)" : "none",
            }}
          >
            <div className="step-num" style={{ marginBottom: 0 }}>
              {s.num}
            </div>
            <div style={{ flex: "1 1 480px", maxWidth: 720 }}>
              <h3 style={{ fontSize: "clamp(19px,2.2vw,26px)", marginBottom: 14 }}>{s.title}</h3>
              <p style={{ fontSize: "15px", color: "rgba(26,23,20,0.65)", maxWidth: 560 }}>
                {s.desc}
              </p>
              <div
                className="svc-label"
                style={{ display: "block", margin: "22px 0 10px" }}
              >
                HODÍ SE, KDYŽ:
              </div>
      ...
      <section className="section container">
        <Tag>— Ceny</Tag>
        <h2 className="h2">Cena podle textu, ne podle ceníku.</h2>
        <p className="perex" style={{ marginTop: 20 }}>
          Každý rukopis potřebuje jinak hluboký zásah — proto nemám jednotný ceník za stranu. Cenu
          stanovuji podle rozsahu, stavu textu a typu práce, vždy předem a za celý projekt, ať
          víte, s čím počítat.
        </p>
      ...
      <section className="section container">
        ...
        <h2 className="h2" style={{ marginBottom: 20 }}>
          Text posunu. Autorem zůstáváte vy.
        </h2>
        <p className="perex" style={{ marginBottom: "clamp(24px,4vw,36px)" }}>
          Pomohu text zlepšit, zpřesnit, sjednotit a profesionalizovat. Nepřebírám ale autorství a
          nedopisuji text za autora.
        </p>
        <div className="limits">
          ...
          <p className="limits-note">
            Pokud budete chtít, mohu do procesu zapojit i další prověřené specialisty, například
            zkušenou jazykovou korektorku.
          </p>
        </div>
      </section>
